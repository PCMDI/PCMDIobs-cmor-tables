...
#%% User provided input
cmorTable = '../Tables/PMPObs_Omon.json' ; # Aday,Amon,Lmon,Omon,SImon,fx,monNobs,monStderr - Load target table, axis info (coordinates, grid*) and CVs
...
inputFilePathend = '/AVISO/'
inputFileName = ['sla_aviso_199301-201812.xml']
inputVarName = ['sla']
outputVarName = ['zos']
outputUnits = ['m']
